...
from .provisioning import async_create_session
...
class EspAnywhereOptionsFlow(config_entries.OptionsFlow):
    """Direct users to the ESPHome-first Builder; legacy board profiles are retired."""

    async def async_step_init(self, user_input=None) -> FlowResult:
        return self.async_abort(reason="builder_required")
