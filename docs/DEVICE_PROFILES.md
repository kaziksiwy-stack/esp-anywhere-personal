...
Every entry defines ID, name, platform, board, flash layout, LED pin/polarity, USB mode and compatible artifact. The OTA bootstrap supports esp32-c3-devkitm-1: native USB CDC, `partitions_ota.csv`, GPIO 8 active-low.
